...
#define cgroup_bpf_enabled(type) static_branch_unlikely(&cgroup_bpf_enabled_key)
...
#define BPF_CGROUP_RUN_PROG_INET4_BIND(sk, uaddr)                                  BPF_CGROUP_RUN_SA_PROG(sk, uaddr, BPF_CGROUP_INET4_BIND)

#define BPF_CGROUP_RUN_PROG_INET6_BIND(sk, uaddr)                                  BPF_CGROUP_RUN_SA_PROG(sk, uaddr, BPF_CGROUP_INET6_BIND)
